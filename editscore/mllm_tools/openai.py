...
import os
from editscore.mllm_tools.mllm_abstract import MLLM
...
class GPT4v(MLLM):
    def __init__(self, api_key_path='keys/secret.env',  model_name="gpt-4-vision-preview"):
...
class GPT4o(GPT4v):
    def __init__(self, api_key_path='keys/secret.env', model_name="gpt-4o-2024-08-06"):
        super().__init__(api_key_path,  model_name)

if __name__ == "__main__":
    model = GPT4o('/home/mila/x/xuolga/keys/olga_personal_metric.env')
    prompt = GPT4o.prepare_image_prompt('https://chromaica.github.io/Museum/ImagenHub_Text-Guided_IE/DiffEdit/sample_34_1.jpg')
    print("prompt : \n", prompt)
